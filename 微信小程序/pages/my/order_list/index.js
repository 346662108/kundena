...
var loadMore = function(that) {
  ...
  wx.request({
    url: config.host + '/User/getOrderListData.htm?t=' + t,
    method: 'POST',
    data: {
    ...
    success: function(res) {
      ...
      var list = that.data.pageOrderList
      if (res.data.pageOrderList) {
        list = list.concat(res.data.pageOrderList);
      }
...
Page({
  ...
  gotoPayment: function(e) {
    let oid = e.currentTarget.dataset.oid || 0;
    wx.navigateTo({
      url: '../../cart/payment/payment?oid=' + oid,
    })
    //旧方法直接支付的
    // let oid = e.currentTarget.dataset.oid || 0;
    ...
    //   method: 'POST',
    //   data: { oid: oid, userId: userId, openid: openid },
